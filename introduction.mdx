...
Aplikasi Simpede adalah perangkat lunak yang dirancang untuk menyederhanakan proses ketatausahaan dengan menyediakan fitur-fitur komprehensif yang mencakup:
  ...
  <Card title="Penggantian Pulsa Mitra" icon="wifi">
  1. Rekapitulasi Bulanan Penggantian Pulsa Mitra
  2. Form Konfirmasi Nomor Handphone
  3. Form upload bukti masuk pulsa
  4. Cetak Otomatis tanda terima pulsa
  </Card>
  <Card title="Digital Payment" icon="credit-card">
  1. Monitoring Penggunaan dan Pembayaran ATM dan KKP
  </Card>
