...
Daftar Penggantian Pulsa Mitra bisa ditambahkan melalui menu `Kerangka Acuan Kerja`. Untuk menambahkan Daftar Penggantian Pulsa, pada `Halaman Indeks` Kerangka Acuan, klik `Tombol Aksi` dan pilih `Tambahkan Pulsa Kegiatan`.


<Frame caption="Tampilan Menambahkan Pulsa Kegiatan">
  ![Tambah Pulsa](../images/buat-pulsa.png)
</Frame>

Selanjutnya, isikan semua keterangan yang dibutuhkan lalu simpan.
<Frame caption="Tampilan Menambahkan Keterangan Pulsa Kegiatan">
  ![Ubah Pulsa](../images/ubah-pulsa.png)
</Frame>
...
<Warning>
  Menu ini hanya muncul pada akun pengelola keuangan (PPK, PBJ, PPSPM, dan Bendahara).
</Warning>
